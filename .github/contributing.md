...
# Contributing to Nectary

Firstly, thank you for taking an interesting in contributing! Nectary is an
...
Nectary is one of a large number of
...
issue](https://github.com/propensive/nectary/issues) or contact the project
...
have commit rights to the `propensive/nectary` repository, push to a branch named
...
in extreme cases. Nectary does not use automatic code-formatting because it
...
Nectary&rsquo;s users. Individualism is valued, and nobody should feel
